...
\begin{proposition}[Simplified formula for the operator power mean]
  ...
  \leanok
  \uses{thm:perspective_rpow_commute}
  ...
  \begin{proof}
    ...
    the generalized perspective simplifies via \texttt{GenPerspective\_of\_rpow\_commute}
...
\begin{theorem}[Lieb concavity --- general form]
  ...
  \leanok
  \uses{def:hstar_algebra, def:mul_operators}
