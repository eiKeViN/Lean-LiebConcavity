...
\begin{theorem}[Joint convexity of the generalized perspective function]
  ...
  \]
  \begin{proof}
    \proves{thm:perspective_joint_convex}
    \leanok
    \uses{thm:jensen_sub, thm:loewner_concave, lem:mul_rpow_commute}
...
\begin{theorem}[Joint concavity of the generalized perspective function]
  ...
  \]
  \begin{proof}
    \proves{thm:perspective_joint_concave}
    \leanok
